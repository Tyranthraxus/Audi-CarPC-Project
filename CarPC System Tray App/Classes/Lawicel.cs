...
public class LAWICEL
    {
        ...
        public const byte CANUSB_FLAG_QUEUE_REPLACE = 0x0002;	// If input queue is full remove oldest message and insert new message.
        ...
        public const byte CANUSB_FLAG_NO_LOCAL_SEND = 0x0010;	// Don't send transmited frames on other local channels for the same interface

        // Filter mask settings
        // Use codes below to receive all frames
        public const uint CANUSB_ACCEPTANCE_CODE_ALL = 0x00000000;
        public const uint CANUSB_ACCEPTANCE_CODE_TV = 0x208C0000;
        public const uint CANUSB_ACCEPTANCE_MASK_ALL = 0xFFFFFFFF;
        public const uint CANUSB_ACCEPTANCE_MASK_TV = 0x10000000;
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_Open")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_Close")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_Read")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_ReadFirst")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_Write")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_Status")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_VersionInfo")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_Flush")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_SetTimeouts")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_getFirstAdapter")]
        ...
        [DllImport("canusbdrv64", EntryPoint = "canusb_getNextAdapter")]
